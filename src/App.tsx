...
const faqs = [
  ...
  },
  {
    ...
    answers: [
      'Вы получаете до 70% прибыли (до 90% на старших тарифах), заработанной на фондовом-аккаунте. Например, на счёте 100 000 ₽ при достижении +10% прибыли ваш доход составит 7 000 ₽ при вложении всего 2 000 ₽ за участие. На счёте 5 000 000 ₽ при тех же +10% — ваша доля составит 350 000 ₽',
    ],
  },
  {
